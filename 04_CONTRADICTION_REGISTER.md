...
|---|---|---|---|---|---|---|
| CT-001 | TDD description | Current TDD/changelog: red → green; refactor moved to review. | Engineering README still describes TDD as red-green-refactor. | DOCS STALE | OPEN | Historical intent is explicit, so this is not ambiguous. |
