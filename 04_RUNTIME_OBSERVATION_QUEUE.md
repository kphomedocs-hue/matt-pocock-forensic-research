...
| B-024 | EXTERNAL_DEPENDENCY_VALIDATION | CONFIRMED_WEAKNESS | YES | MP-0099, MP-0110 | triage exclusive state/category invariant | Prompt-level red-team testing remains needed to determine whether a real triage agent flags/removes conflicts before acting; this external observation does not establish agent adherence. |
