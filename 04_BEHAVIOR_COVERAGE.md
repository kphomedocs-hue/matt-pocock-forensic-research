...
Skills with at least one Phase 4 behavior row: **22/37**.
Uncovered current skills: **15**.
...
| MP-0076 | `skills/engineering/domain-modeling/SKILL.md` | YES | B-028 | CONFIRMED_MATCH | — |
| MP-0078 | `skills/engineering/grill-with-docs/SKILL.md` | NO | — | — | — |
...
| MP-0091 | `skills/engineering/resolving-merge-conflicts/SKILL.md` | NO | — | — | — |
...
| MP-0129 | `skills/in-progress/writing-beats/SKILL.md` | NO | — | — | — |
| MP-0131 | `skills/in-progress/writing-fragments/SKILL.md` | NO | — | — | — |
| MP-0133 | `skills/in-progress/writing-shape/SKILL.md` | NO | — | — | — |
| MP-0136 | `skills/misc/git-guardrails-claude-code/SKILL.md` | YES | B-016 | STATICALLY_ENFORCED | — |
| MP-0139 | `skills/misc/migrate-to-shoehorn/SKILL.md` | NO | — | — | — |
| MP-0141 | `skills/misc/scaffold-exercises/SKILL.md` | NO | — | — | — |
| MP-0143 | `skills/misc/setup-pre-commit/SKILL.md` | YES | B-017 | STATICALLY_ENFORCED | — |
| MP-0146 | `skills/productivity/grill-me/SKILL.md` | NO | — | — | — |
| MP-0148 | `skills/productivity/grilling/SKILL.md` | NO | — | — | — |
| MP-0150 | `skills/productivity/handoff/SKILL.md` | NO | — | — | — |
| MP-0156 | `skills/productivity/teach/SKILL.md` | YES | B-005, B-006 | CONFIRMED_GAP, RUNTIME_UNKNOWN | CT-005, CT-006 |
| MP-0158 | `skills/productivity/to-questionnaire/SKILL.md` | NO | — | — | — |
| MP-0160 | `skills/productivity/wait-what/SKILL.md` | NO | — | — | — |
| MP-0163 | `skills/productivity/writing-for-agents/SKILL.md` | NO | — | — | — |
