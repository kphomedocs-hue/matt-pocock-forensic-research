...
Latest published durable classifier snapshot: **149 incident entries** from **125 failed + 24 cancelled runs**.
...
1. Continue the **17 pending execution observations** in small deterministic batches.
