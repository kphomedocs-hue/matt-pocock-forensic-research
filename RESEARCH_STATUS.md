...
- behavior rows: **65**;
- runtime observed: **16/65**;
- total pending stronger evidence: **49**;
...
- `EXTERNAL_DEPENDENCY_VALIDATION`: **2 observed / 5 pending**;
...
Latest published durable classifier snapshot: **189 incident entries** from **151 failed + 38 cancelled runs**.
